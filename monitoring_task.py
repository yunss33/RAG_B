...
logging.basicConfig(
    ...
    handlers=[
        logging.FileHandler(log_dir / "monitoring_task.log"),
        logging.StreamHandler()
    ]
)

logger = logging.getLogger("monitoring_task")

# 3小时 = 10800秒
MONITORING_INTERVAL = 3 * 60 * 60
...
async def main():
    """主函数 - 持续运行监控任务"""
    logger.info("=" * 80)
    logger.info("投标文档生成系统 - 定时任务监控系统")
    logger.info("=" * 80)
    logger.info(f"监控间隔: {MONITORING_INTERVAL}秒 ({MONITORING_INTERVAL/3600}小时)")
